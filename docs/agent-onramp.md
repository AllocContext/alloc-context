...
The hosted MCP at `mcp.alloc-context.com` is **retired**. **Self-host** via
PyPI (stdio MCP + local SQLite).

Deep docs: [cursor-mcp.md](cursor-mcp.md) · [self-hosting.md](self-hosting.md)
· [agent-integration.md](agent-integration.md) · [examples.md](examples.md)
· [mcp.md](mcp.md)
...
analysis). With ingest configured, omitting `assets` auto-scopes market data to
your holdings.
